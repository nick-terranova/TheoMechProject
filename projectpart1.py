'''
ProjectPart1.py
Moving unicycle with simple harmonic oscilator
'''
...
seat = box( pos = (bike_x,  5.25, 0) , lenght = 2.0, width = .5, height = .5)

# initialize the velocity of the seat in the bike's reference frame
seat.vel = vector(0,-3,0)
...
def oscillate(s):
    a = k*(spring_length-s)*vector(0,1,0)
    seat.vel += a*dt
